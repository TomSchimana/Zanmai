...
## The one line before anything is written

You get a single sentence naming what will be written, plus at most three bullets where a real choice was made. You answer go, or you change one word in it. That is the whole gate, and it is deliberately not a form.

Three more things are settled without asking you: the source and what is out of scope, so nothing from general knowledge leaks in as though it came from your recording; who reads it and who appears by name; and where it lands, so you are not rebuilding it by hand.

## What it will not do

It does not tell you what to do. No suggested approach, no "you should", no ranking of your own topics by importance. In a document that is yours, that is the worst thing it can do, because it overwrites your judgement inside your own notes. If you ask for a recommendation you get one, in its own section, and asking once does not turn the rest of the document into advice.

It does not transcribe what you attached. A screenshot or a file you send along tells the writer what this is about. It is not a list of fields to copy in. Your colleague's job title, office hours and reporting line do not appear in your meeting notes because a profile card happened to be in the thread.
...
If you say who, that settles it.

Otherwise it goes by where the material is. When you dictated the points, or the substance came up in the conversation you are in, it is written right there. Handing that to a background specialist would throw away everything already understood and buy you a wait plus a summary of a summary.

When the material sits in files nobody has read yet, a transcript, a bundle of forty documents, a source to go through, it runs in the background and you are told in one line that it is running. It starts on the material rather than on the conversation, and you can carry on meanwhile.
...
`/zanmai-write` asks directly. You rarely need it: a document is written whenever a document is what you asked for.

## Related

- [Speaking instead of typing](voice.md), how a recording is read
- [Research](research.md), when the answer needs sources rather than your own material
- [Designing documents](design.md), when it has to look like your organisation made it
- [Your brand](brand.md), where the voice comes from
