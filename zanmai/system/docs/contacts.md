...
People live in `contacts/people`, organisations in `contacts/organisations`, one note each. The fields at the top of the note hold the structured facts, role, organisation, email, phone, and the body is for whatever you want to write about them.
