---
name: wong
description: Connections and security in one role. Dispatched when a source outside the vault needs a connection, a credential or an authenticated protocol. What Steve already reaches he reads himself.
