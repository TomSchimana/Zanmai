...
- [ZenNotes](zennotes.md) and its `zn` helper. Zanmai works as plain Markdown without it. ZenNotes is a nice local editor and viewer that also adds an inbox and daily and weekly notes.
