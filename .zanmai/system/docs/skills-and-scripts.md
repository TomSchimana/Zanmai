...
The current distribution ships nineteen skills, three scripts (`zanmai.py`, a standalone `image-edit.py` and `design-check.py`), five hooks and seven subagents (plus Steve, the main-loop concierge).
