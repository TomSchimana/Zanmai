...
Your notes are plain Markdown, so they open in any editor and you need nothing special to read or write them. ZenNotes is an optional companion, a local editor that adds an inbox, daily, weekly and monthly notes, and fast search. You can add it whenever you like and Zanmai picks it up.
